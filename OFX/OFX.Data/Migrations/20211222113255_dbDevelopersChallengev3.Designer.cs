...
namespace OFX.Data.Migrations
{
    ...
    [Migration("20211222113255_dbDevelopersChallengev3")]
    partial class dbDevelopersChallengev3
    {
            ...
            modelBuilder.Entity("OFX.Domain.Entities.Account", b =>
                {
                    b.HasOne("OFX.Domain.Entities.Statement", "Statement")
                        .WithOne("Account")
                        .HasForeignKey("OFX.Domain.Entities.Account", "StatementId")
            ...
            modelBuilder.Entity("OFX.Domain.Entities.Status", b =>
                {
                    b.HasOne("OFX.Domain.Entities.Statement", "Statement")
                        .WithOne("Status")
                        .HasForeignKey("OFX.Domain.Entities.Status", "StatementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
