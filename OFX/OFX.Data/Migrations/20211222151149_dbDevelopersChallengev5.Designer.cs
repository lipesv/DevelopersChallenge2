...
namespace OFX.Data.Migrations
{
    ...
    [Migration("20211222151149_dbDevelopersChallengev5")]
    partial class dbDevelopersChallengev5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OFX.Domain.Entities.Statement", b =>
                {
                    b.HasOne("OFX.Domain.Entities.Account", "Account")
                        .WithOne("Statement")
                        .HasForeignKey("OFX.Domain.Entities.Statement", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OFX.Domain.Entities.Status", "Status")
                        .WithOne("Statement")
                        .HasForeignKey("OFX.Domain.Entities.Statement", "StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
